...
.method public final setAlarm(IJLjava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/samsung/android/thememanager/period/PeriodManager;->setSideloadAlarm(IJLjava/lang/String;)V
    ...
    const-string p2, "setTrialAlarm: startTime="
    ...
    invoke-static {v0, p1}, Lcom/samsung/android/thememanager/log/Log;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lcom/samsung/android/thememanager/log/Log;->addLogString(Ljava/lang/String;)V

    new-instance p1, Landroid/content/Intent;

    iget-object p2, p0, Lcom/samsung/android/thememanager/period/PeriodManager;->mContext:Landroid/content/Context;

    const-class p3, Lcom/samsung/android/thememanager/ThemeManagerService;

    invoke-direct {p1, p2, p3}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    const-string p2, "com.samsung.android.theme.action.TRIAL_THEME_NOTIFICATION"
    ...
    iget-object p3, p0, Lcom/samsung/android/thememanager/period/PeriodManager;->mContext:Landroid/content/Context;

    const/high16 v0, 0x22000000

    const/4 v6, 0x0

    invoke-static {p3, v6, p1, v0}, Landroid/app/PendingIntent;->getService(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p3, v7, p4}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string p4, "trial_start_time"

    invoke-virtual {p3, p4, v2, v3}, Landroid/os/Bundle;->putLong(Ljava/lang/String;J)V

    const-string p4, "trial_total_time"

    const-wide/32 v2, 0x927c0

    invoke-virtual {p3, p4, v2, v3}, Landroid/os/Bundle;->putLong(Ljava/lang/String;J)V

    const-string p4, "trial_title"

    const-string v2, ""

    invoke-virtual {p3, p4, v2}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string p4, "extra_bundle"

    invoke-virtual {p1, p4, p3}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Bundle;)Landroid/content/Intent;
    ...
    invoke-virtual {p2, v1, v4, v5, p0}, Landroid/app/AlarmManager;->setExact(IJLandroid/app/PendingIntent;)V
